...
# C
        ...
        it_d += 1
        writer.add_scalar('loss_mask_mse', loss_mask_mse.cpu().numpy(), global_step=it_d)
        writer.add_scalar('loss_mask_ssim', loss_mask_ssim.cpu().numpy(), global_step=it_d)
        writer.add_scalar('loss_mask_lpips', loss_mask_lpips.cpu().numpy(), global_step=it_d)
        writer.add_scalar('loss_grad_mse',  loss_grad_mse.cpu().numpy(), global_step=it_d)
        writer.add_scalar('loss_grad_ssim', loss_grad_ssim.cpu().numpy(), global_step=it_d)
        writer.add_scalar('loss_grad_lpips', loss_grad_lpips.cpu().numpy(), global_step=it_d)
